...
public abstract class Numberable : Tile
{
    ...
    private bool IsCorrectNumber(Numberable neighbour)
    {
        bool match = Mathf.Abs(neighbour.Number - this.Number) == 1;
        return match;
    }
    //private bool IsCorrectNumber(Numberable neighbour) => neighbour.Number == Number;
    ...
    public virtual void SetNumberable() => boarded = true; 
